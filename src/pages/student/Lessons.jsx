...
const COURSES = [
  {
    ...
    subtitle: 'Reading',
    description:
      'Metinler, hikayeler ve makalelerle okuma becerinizi geliştirin.',
    progress: 45,
    lessons: '8 / 18 Ders',
  ...
  },
  {
    ...
    title: 'Yazma',
    subtitle: 'Writing',
    description: 'Paragraf, e-posta ve kompozisyon yazma pratikleri yapın.',
    progress: 30,
    lessons: '5 / 16 Ders',
  ...
  },
  {
    ...
    subtitle: 'Listening',
    description:
      'Diyaloglar, podcast ve konuşmaları dinleyerek anlama gücünüzü artırın.',
    progress: 60,
    lessons: '12 / 20 Ders',
    color: '#f97316',
    bgLight: '#f9731612',
    ...
    <>
      ...
      <Box sx={{ mb: 1 }}>
        ...
        <Typography sx={{ fontSize: 14, color: colors.onSurfaceVariant }}>
          Beceri alanını seç ve öğrenmeye başla.
        </Typography>
      </Box>
